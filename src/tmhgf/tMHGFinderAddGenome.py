...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="tMHG-Finder:-add-genome: add new genomes to an already partitioned set of existing genomes")
    parser.add_argument('-og',"--old_temp_genome_dir", type=str, required=True, help="Path to the old tMHG-Finder temp genome directory, this is NOT the previous genome directory, but the tMHG-Finder temporary genome directory")
    parser.add_argument('-om',"--old_mhg_output_dir", type=str, required=True, help="Path to the old tMHG-Finder output directory which should contain an MHG set for each internal node")
    parser.add_argument('-g',"--new_genome_dir", type=str, required=True, help="Directory contaning the new set of genomes")
    parser.add_argument('-o','--mhg_output_dir', default = "tMHG_new_output/", help='Directory storing the new MHG output')
    parser.add_argument('-tg',"--new_temp_genome_dir", default = "tMHG_new_temp_genome/", type=str, help="Directory storing a copy of each genome and representative genomes")
    parser.add_argument('-b','--blastn_dir', default = "tMHG_new_blastn/", help='Directory storing blastn results')
